package com.tian.common.constant;
...
public class MessageConstant {
    ...
    public static final String BACKEND_ERROR = "后台连接错误";
    ...
    public static final String ORDER_SUBMIT_FAIL = "预约失败";
    ...
    public static final String SEND_VALIDATECODE_ERROR = "验证码发送失败，请确认手机号是否正确！";
}
